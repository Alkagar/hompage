<?php
   class Alk_Social_Widget extends WP_Widget {
      private $socials = array(
         'facebook' => "<a target='window_facebook' href='[href]'><img src='[imgPath]/gfx/social-ico/f.png' width='16' class='site_social_ico' alt='fb' /></a>",

         'flickr' => "<a target='window_flickr' href='[href]'><img src='[imgPath]/gfx/social-ico/fcr.png' width='16' class='site_social_ico' alt='flcr' /></a>",
         'github' => "<a target='window_github' href='[href]'><img src='[imgPath]/gfx/social-ico/gh.png' width='16' class='site_social_ico' alt='gh' /></a>",
         'mail' => "<a href='[href]'><img src='[imgPath]/gfx/social-ico/mail.png' width='16' class='site_social_ico' alt='@' /></a>",
      );

...
function wp_install_defaults($user_id) {
	...
	$wpdb->insert( $wpdb->terms, array('name' => $cat_name, 'slug' => $cat_slug, 'term_group' => 0) );
	$wpdb->insert( $wpdb->term_taxonomy, array('term_id' => '2', 'taxonomy' => 'link_category', 'description' => '', 'parent' => 0, 'count' => 3));

	// Now drop in some default links
	$default_links = array();
	$default_links[] = array(	'link_url' => 'http://wordpress-polska.org/',
								'link_name' => 'WordPress',
								'link_rss' => '',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://wordpress-polska.org/download/wordpress',
								'link_name' => 'WordPress Download',
								'link_rss' => '',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://wordpress-polska.org/hosting',
								'link_name' => 'WordPress Hosting',
								'link_rss' => '',
								'link_notes' =>'');
